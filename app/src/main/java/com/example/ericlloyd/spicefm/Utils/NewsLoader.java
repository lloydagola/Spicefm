...
/**
 * Created by Eric Lloyd on 04-Nov-17.
 */

public class NewsLoader extends android.support.v4.content.AsyncTaskLoader<ArrayList<NewsArticle>> {
    private final String LOG_TAG = "NewsLoader";
    ...
    public ArrayList<NewsArticle> loadInBackground() {
        ...
        ArrayList<NewsArticle> newsArticleArrayList = QueryUtils.fetchNewsArticles(urlString);
        //ArrayList<NewsArticle> newsArticleArrayList = QueryUtils.extractNewsFromJson(JSON_RESPONSE);
