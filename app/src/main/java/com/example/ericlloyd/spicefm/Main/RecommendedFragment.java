 ...
 */
public class RecommendedFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<NewsArticle>> {

    private static final String LOG_TAG = "RecommendedFragment" ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardRecyclerView = (RecyclerView) rootView.findViewById(R.id.business_cards_recycler_view);
        cardRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), cardRecyclerView, new ClickListener() {
                ...
                public void onClick(View view, final int position) {
                    NewsArticle currentNewsArticle = newsArticles.get(position);
    ...
    public void onLoadFinished(Loader<ArrayList<NewsArticle>> loader, ArrayList<NewsArticle> data) {
        ...
        newsStoriesAdapter = new NewsRecyclerAdapter(getContext(), data, "snippet_tile");

        //cardRecyclerView.setAdapter(new NewsRecyclerAdapter(getContext(), QueryUtils.extractNewsFromJson(JSON_RESPONSE), 4));
        ...
        cardRecyclerView.addItemDecoration(new DividerItemDecoration(getActivity(),
